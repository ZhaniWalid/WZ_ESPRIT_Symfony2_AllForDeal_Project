...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'usn.form.type.newsletter' => 'getUsn_Form_Type_NewsletterService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'pidev_allfordeal', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\vendor\\usn\\newsletter-bundle\\Resources\\config\\doctrine') => 'Usn\\NewsletterBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Pidev\\AllForDealBundle\\Entity'))), 'Pidev\\AllForDealBundle\\Entity');
        $b->addDriver($a, 'Usn\\NewsletterBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('PidevAllForDealBundle' => 'Pidev\\AllForDealBundle\\Entity', 'UsnNewsletterBundle' => 'Usn\\NewsletterBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8e230a479ba64545a573317dd6cdb5093ef77532f900316983a978358f9e7a9d');
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('validos11@gmail.com');
        $a->setPassword('googleTech14isTheBest');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin(array(0 => 'walid.zhani@esprit.tn'), array());
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Pidev\\AllForDealBundle/Resources/translations\\messages.en.yml'), 'en', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Pidev\\AllForDealBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\usn\\newsletter-bundle/Resources/translations\\messages.en.yml'), 'en', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\usn\\newsletter-bundle/Resources/translations\\messages.ja.yml'), 'ja', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\usn\\newsletter-bundle/Resources/translations\\validators.en.yml'), 'en', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\usn\\newsletter-bundle/Resources/translations\\validators.ja.yml'), 'ja', 'validators');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Pidev\\AllForDealBundle/Resources/views'), 'PidevAllForDeal');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/views'), 'KnpPaginator');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\usn\\newsletter-bundle/Resources/views'), 'UsnNewsletter');
    ...
    /**
     * Gets the 'usn.form.type.newsletter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Usn\NewsletterBundle\Form\Type\NewsletterType A Usn\NewsletterBundle\Form\Type\NewsletterType instance.
     */
    protected function getUsn_Form_Type_NewsletterService()
    {
        return $this->services['usn.form.type.newsletter'] = new \Usn\NewsletterBundle\Form\Type\NewsletterType();
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PidevAllForDealBundle' => 'Pidev\\AllForDealBundle\\PidevAllForDealBundle',
                'KnpPaginatorBundle' => 'Knp\\Bundle\\PaginatorBundle\\KnpPaginatorBundle',
                'UsnNewsletterBundle' => 'Usn\\NewsletterBundle\\UsnNewsletterBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'pidev_allfordeal',
            'database_user' => 'root',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'validos11@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'googleTech14isTheBest',
            'swiftmailer.mailer.default.transport.smtp.auth_mode' => 'login',
            'swiftmailer.mailer.default.transport.smtp.timeout' => 30,
            'swiftmailer.mailer.default.transport.smtp.source_ip' => NULL,
            'swiftmailer.mailer.default.spool.enabled' => false,
            'swiftmailer.mailer.default.plugin.impersonate' => NULL,
            'swiftmailer.mailer.default.single_address' => 'walid.zhani@esprit.tn',
            'swiftmailer.mailer.default.delivery_addresses' => array(
                0 => 'walid.zhani@esprit.tn',
            ),
            ...
            'swiftmailer.single_address' => 'walid.zhani@esprit.tn',
