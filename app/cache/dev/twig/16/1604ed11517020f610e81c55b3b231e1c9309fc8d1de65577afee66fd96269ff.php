...
/* PidevAllForDealBundle:CompteUser:UserContactUs.html.twig */
class __TwigTemplate_8228c931a2f690f0c6d06a133d32d1c69ef7b46f1c8ea34b25e40eddfb74cb2f extends Twig_Template
{
                                    ...
                                    <div class=\"modal-dialog\" role=\"document\">
                                        <div class=\"modal-content\">
                                            ...
                                            <div class=\"modal-body\"> 
                                                <p style=\"font-family:Times New Roman;font-size: 24px;color: green\" > Félicitation ! Inscription a été éffectué avec succés dans notre site All For Deal 
                                            </div>
...
\t\t   <form class=\"contact\" method=\"post\" action=\"";
        // line 873
        echo $this->env->getExtension('routing')->getPath("pidev_all_for_deal_ActionContactUserNonConnected");
        echo "\">
\t\t\t  <input type=\"text\" class=\"text\" name=\"email_name\" required value=\"\" placeholder='Name' onfocus=\"this.value = '';\" onblur=\"if (this.value === '') {this.value = 'Name';}\">
\t\t\t  <input type=\"text\" class=\"text\" name=\"email_mail\"  required value=\"\" placeholder='Email' onfocus=\"this.value = '';\" onblur=\"if (this.value === '') {this.value = 'Email';}\">
...
\t\t\t<li><a href=\"classified_database.html\">Database</a></li>!-->
    ...
    {
        return "PidevAllForDealBundle:CompteUser:UserContactUs.html.twig";
    }

    public function getDebugInfo()
    {
        return array (  1630 => 821,  1627 => 820,  1620 => 822,  1618 => 820,  1610 => 815,  1590 => 798,  1586 => 796,  1583 => 795,  1400 => 552,  1389 => 543,  1386 => 542,  1336 => 492,  1321 => 479,  1318 => 478,  1312 => 468,  1302 => 469,  1300 => 468,  1294 => 464,  1291 => 463,  1271 => 1138,  1267 => 1137,  1251 => 1124,  1247 => 1123,  1243 => 1122,  1239 => 1121,  1235 => 1120,  1231 => 1119,  1226 => 1117,  1222 => 1116,  1218 => 1115,  1214 => 1114,  1193 => 1096,  1189 => 1095,  1138 => 1047,  1134 => 1046,  1110 => 1024,  1095 => 1011,  1080 => 999,  1053 => 975,  1049 => 974,  1042 => 970,  1038 => 969,  1031 => 965,  1027 => 964,  1020 => 960,  1016 => 959,  1009 => 955,  1005 => 954,  998 => 950,  994 => 949,  988 => 946,  984 => 945,  978 => 942,  974 => 941,  903 => 873,  879 => 852,  851 => 826,  849 => 795,  782 => 730,  780 => 542,  774 => 538,  772 => 478,  767 => 475,  765 => 463,  751 => 452,  743 => 448,  334 => 38,  331 => 37,  324 => 33,  318 => 30,  314 => 29,  308 => 26,  303 => 24,  299 => 23,  294 => 21,  290 => 20,  286 => 19,  281 => 17,  276 => 15,  272 => 14,  268 => 13,  263 => 11,  252 => 4,  247 => 443,  245 => 37,  242 => 36,  237 => 4,  229 => 1284,  220 => 1280,  216 => 1279,  193 => 1258,  184 => 1254,  180 => 1253,  158 => 1233,  149 => 1229,  145 => 1228,  120 => 1205,  111 => 1201,  107 => 1200,  85 => 1180,  76 => 1176,  72 => 1175,  49 => 1154,  47 => 448,  42 => 445,  40 => 4,  36 => 2,  30 => 1,);
    }
}
/* {% block html %}*/
/* <!DOCTYPE html>*/
...
/* 	<div class="container">*/
/* 		<h2>Contact</h2>*/
/* 		<span class="breadcrumbs"><a href="{{ path("pidev_all_for_deal_UserContactUs") }}"><i class="fa fa-home home_1"></i></a> / <span>Contact</span></span>*/
/* 	</div>*/
/* </div>*/
/* <div class="about_top">*/
/*  <div class="container">*/
...
/* 	  <h3>Feedback</h3>*/
/* 	   <p class="m_4">"En cas de panne du notre site , nouvelle idée d'amèlioration du notre site ou bien une demande d'ajouter de nouveaux catégories de produits à etre vendus sur notre site ... n'hésitez pas de nous donner un feedback en remplissant le formulaire çi dessous."</p>*/
/* 		   <form class="contact" method="post" action="{{ path("pidev_all_for_deal_ActionContactUserNonConnected") }}">*/
/* 			  <input type="text" class="text" name="email_name" required value="" placeholder='Name' onfocus="this.value = '';" onblur="if (this.value === '') {this.value = 'Name';}">*/
/* 			  <input type="text" class="text" name="email_mail"  required value="" placeholder='Email' onfocus="this.value = '';" onblur="if (this.value === '') {this.value = 'Email';}">*/
/* 			<!--  <input type="text" class="text" name="email_subject" required value="Subject" onfocus="this.value = '';" onblur="if (this.value === '') {this.value = 'Subject';}">!-->*/
/*                            <div class="section">*/
