...
use Pidev\AllForDealBundle\Entity\Newsletter;
/**
...
class NewsLetterController extends Controller{
   ...
   public function subscribeAction(Request $request){
    ...
    //   $request=$this->getRequest();
        ...
        if($request->getMethod() == 'POST'){
         ...
         // $form->handleRequest($request);
          ...
          if ($request) {
              ...
              else return $this->redirect($this->generateUrl('pidev_newsletter_complete'));
          }
        ...
        return $this->render('PidevAllForDealBundle:Acceuil:Acceuil.html.twig');
    }
    ...
    public function completeAction(){
         ...
         return $this->render('PidevAllForDealBundle:NewsLetter:complete.html.twig');
